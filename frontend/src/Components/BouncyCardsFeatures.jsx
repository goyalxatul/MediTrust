...
export const BouncyCardsFeatures = () => {
  ...
  <div className="mb-8 flex flex-col items-start justify-between gap-4 md:flex-row md:items-end md:px-8">
    <h2 className="max-w-lg text-4xl font-bold md:text-5xl">
      Experience MediTrust with  
      <span className="text-slate-400"> Smart & Secure Solutions</span>
    </h2>
    <motion.button
  ...
  <div className="mb-4 grid grid-cols-12 gap-4">
    <BounceCard className="col-span-12 md:col-span-4">
      <CardTitle>Seamless Patient Management</CardTitle>
    ...
    <BounceCard className="col-span-12 md:col-span-8">
      <CardTitle>End-to-End Encrypted Health Data</CardTitle>
  ...
  <div className="grid grid-cols-12 gap-4">
    <BounceCard className="col-span-12 md:col-span-8">
      <CardTitle>AI-Powered Medical Insights</CardTitle>
    ...
    <BounceCard className="col-span-12 md:col-span-4">
      ...
      <div className="absolute bottom-0 left-4 right-4 top-32 translate-y-8 rounded-t-2xl bg-gradient-to-br from-pink-400 to-red-400 p-4 transition-transform duration-[250ms] group-hover:translate-y-4 group-hover:rotate-[2deg]">
        <span className="block text-center font-semibold text-red-50">
          Easy upload and download of medical records.
        </span>
      </div>
    </BounceCard>
  </div>
